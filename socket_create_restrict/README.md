...
`CVE-2023-51782` (ROSE UAF). Unlike a privilege check, this policy applies
to root too — the whole point is to keep these code paths unreachable
...
- The denylist is a compile-time `switch` in
  ...
  remove it from the list and rebuild.
